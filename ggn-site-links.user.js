...
var sites = [
    ...
    ["itch", "itch.io", ""],
	["origin", "origin.com", ""],
	["pcwiki", "pcgamingwiki.com", ""],
	["nexusmods", "nexusmods.com", ""],
    ["epicgames", "epicgames.com", ""],
    ["psn", "playstation.com", ""],
    ["xbox", "marketplace.xbox.com", ""],
    ["itunes", "itunes.apple.com", ""],
    ["rpggeek", "rpggeek.com", ""],
    ["rpgnet", "index.rpg.net", ""],
...
function add_search_buttons() {
    ...
    $("#search_weblinks").click(function() {
        ...
        window.open("https://howlongtobeat.com/?q=" + title, '_blank');
        ...
        if ($("#nexusmodsuri").length !== 0) {	//Windows only
            ...
            window.open("https://www.epicgames.com/store/en-US/browse?q="+title, '_blank');
        }
